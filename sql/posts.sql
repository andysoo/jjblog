...
insert into `posts` (`user_id`,`title`,`content`,`post_date`) values  
  ('andy','发贴标题0','发贴内容0','2018-10-07 19:56:00'),
  ...
  ('andy','发贴标题6','发贴内容4','2018-10-07 19:56:04'),
  ('andy','发贴标题7','发贴内容4','2018-10-07 19:56:04'),
  ('andy','发贴标题8','发贴内容4','2018-10-07 19:56:04'),
  ('andy','发贴标题9','发贴内容4','2018-10-07 19:56:04');
